...
namespace ShareX_windows.Helpers
{
    ...
    public class MicaBackDrop
    {
        ...
        public MicaBackDrop(Window window)
        {
            _window = window;
        }

        WindowBackdropHelper m_wsdqHelper; // See separate sample below for implementation
        ...
        {
            var isBackdropSet = TrySetMicaBackdrop();
            //if(!isBackdropSet)
            //{
        ...
        private bool TrySetMicaBackdrop()
        {
            ...
            {
                m_wsdqHelper = new WindowBackdropHelper();
        ...
        private void Window_Closed_acrylic(object sender, WindowEventArgs args)
        {
            // Make sure any Mica/Acrylic controller is disposed so it doesn't try to
            // use this closed window.
