...
class SendFragment(u: SocketHelper) : Fragment() {
...
//        try {
//            val icon = requireContext().packageManager.getApplicationIcon("com.whatsapp")
//            view.findViewById<ImageView>(R.id.img1).setImageDrawable(icon);
...
//        }
        ...
        sendFilesBtn.setOnClickListener {
            ...
            if(!transferring){
                ...
                Toast.makeText(view.context, "cannot send files now.", Toast.LENGTH_SHORT).show()
...
//                editor.apply()
        ...
        {
            Log.d("TAG", "sendFiles: not sending...............")
            sending = false
        }
    }
